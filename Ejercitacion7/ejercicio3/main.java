...
public class main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < pacientes.length; i++) {
            h.agregarPaciente(pacientes[i]);
        }

        h.listarPacientes();
        h.cantidadPacientes();

        System.out.println("paciente indice 4");
        System.out.println("edad: " + pacientes[4].edad);
        System.out.println("hospitalizado: "
                + pacientes[4].estaHospitalizado);

        System.out.println("-------------------");

        System.out.println("paciente indice 12");
        System.out.println("edad: " + pacientes[12].edad);
        System.out.println("hospitalizado: "
                + pacientes[12].estaHospitalizado);
    }
}